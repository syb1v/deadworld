...
## v0.1.0 — MVP vertical slice

- authoritative online movement;
- shared zombies;
- combat;
- shared loot;
- inventory;
...
- `v0.1.0-prealpha.3`: release-signed universal Android APK, native Linux packages, 32/64-bit and ARM desktop matrix, standalone Windows executables and installation documentation;
...
- Google Play Internal Testing distribution to reduce sideload security warnings;
- macOS/Xcode iOS export pipeline, Apple signing and TestFlight after MVP stabilization.
...
> маленький, но уже самостоятельный online Zomboid-like survival.

## v0.3 — Social Survival
...
## v0.6 — MMO World Scaling

- spatial interest management;
- zone processes;
- player handoff;
- entity handoff;
- far-zombie simulation;
- load tests;
- hundreds of CCU target experiments.
...
- cities;
- farms;
- military/medical/industrial areas;
- bunkers/labs;
- world events;
- migrating hordes.
...
Persistent crossplay survival world with:
...
Каждая версия начинается только если предыдущая доказана игровым тестом.
